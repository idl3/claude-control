...
export const SessionTransportSchema = z.enum([
  'tmux',
  'rpc',
  'print',
  'olam',
...
// Presentation is independent from harness identity. CodeWhale terminal mode
// is kind:'codewhale' + presentation:'terminal'; its later Runtime adapter can
// remain kind:'codewhale' while switching to presentation:'thread'. Optional
// for backward compatibility with remote/older producers during rollout.
export const SessionPresentationSchema = z.enum(['thread', 'terminal']);
...
export const SessionEntrySchema = z.object({
  ...
  presentation: SessionPresentationSchema.optional(),
