 ...
 *       {
 *         "org": "atlas",
 *         "runnerUrl": "https://<atlas-runner>",
 *         "spaBase": "https://<atlas-spa>",
 *         "gsmProject": "<gcp-project>",            // optional (default shown)
 *         "gsmAccount": "<operator-account>",  // optional (default shown)
 *         "runnerTokenGsmSecret": "<atlas-runner-token-secret>", // optional (default: olam-<org>-sandbox-runner-token)
 *         "runnerTokenFiles": ["<atlas-runner-token-file>"] // optional fallbacks, tried after GSM
 *       }
 *     ]
 *   }
 *
...
const DEFAULT_GSM_PROJECT = '<gcp-project>';
const DEFAULT_GSM_ACCOUNT = '<operator-account>';
