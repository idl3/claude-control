...
import { detectMachine, recommendMlxModel, recommendClaudeModel, CLAUDEX_MODELS } from './models.js';
 ...
 *
 * @param {{ launchCommand?: unknown, defaultCwd?: unknown, optimizeModel?: unknown, claudeBin?: unknown, codexLaunchCommand?: unknown, codexBin?: unknown, claudexModel?: unknown, skipPermissions?: unknown }} partial
 * @returns {{ launchCommand: string, defaultCwd: string, optimizeModel: string, claudeBin: string, codexLaunchCommand: string, codexBin: string, claudexModel: string, optimizeBackend: string, mlxModel: string, skipPermissions: boolean }} the saved config
 */
