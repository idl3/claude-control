...
- [ ] Complete `cloudflared access login https://<atlas-spa>` (operator SSO; prompt if absent)
...
- [ ] Secret resolver: GSM-first (`<operator-account>` account), file fallback, in-memory only
