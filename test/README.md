...
- **tmux / terminal** — `tmux-capture`, `tmux-sendtext` (paste→poll-Pasting→Enter), `pty-bridge` (binary PTY dedup/LRU, replaces the retired ttyd lifecycle), `shell`, `shell-keys`.
