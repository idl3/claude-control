...
export function Thread({ hasSelection, sessionId, hiddenCount, onLoadEarlier }: ThreadProps) {
  return (
    <ThreadPrimitive.Root className="thread-root">
      ...
      {/* Tail-to-bottom button. MUST live OUTSIDE the Viewport: a position:sticky
          child inside an iOS momentum-scroll container (-webkit-overflow-
          scrolling: touch) breaks transcript scrolling. As a sibling it's
          absolutely positioned above the composer instead. Auto-scroll keeps the
          thread pinned at the bottom; the primitive disables itself there and CSS
          fades it out. */}
